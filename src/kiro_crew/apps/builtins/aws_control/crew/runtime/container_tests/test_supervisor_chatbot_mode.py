...
A suite that runs with ``backup_bucket=None`` and asserts the sidecar starts
encodes the boot loop as correct, which is why these tests exist separately: they
assert the mode, not the wiring.
"""
