...
def _vet_script_contents(text: str) -> str | None:
    ...
    PATCH handler, or ``kirocrew cron update --sandbox``; the MCP cron tools do
            ...
            "inputSchema": {
                ...
                "properties": {
                    ...
                    "script": {
                        ...
                        "'standard' sandbox from the REST API or "
                        "`kirocrew cron update --sandbox standard`; you cannot.",
                    },
                    "command": {
                        "type": "string",
    ...
    if name == "cron_add":
        ...
        if script:
            sandbox_note = (
                ...
                "sandbox from the REST API or `kirocrew cron "
                "update` -- you cannot set that yourself."
            )
        return (
