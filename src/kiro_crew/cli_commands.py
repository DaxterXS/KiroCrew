...
def _memory_cmd(args: argparse.Namespace) -> None:
    ...
    if action == "compact-revisions":
        from kiro_crew._sqlite_compat import sqlite3
        from kiro_crew.memory_revision_compaction import compact_revisions

        try:
            result = compact_revisions(
                args.store,
                args.before,
                apply=args.apply,
            ...
            print(f"Memory compaction refused: {exc}", file=sys.stderr)
