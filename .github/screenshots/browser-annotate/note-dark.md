...
Viewport: 960×620 CSS px. The attached image `browser-annotation-2026-09-09T20-56-07.png` is this viewport with the user's marks drawn on it; coordinates below are CSS px in that image.
