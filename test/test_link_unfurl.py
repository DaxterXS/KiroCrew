...
class TestPinnedResolver:
    ...
    def test_the_handler_installs_it_on_its_connector(self) -> None:
        """Pins the lift: the class moved to `link_unfurl`, the handler still uses
        it, so the dashboard fetch is still pinned."""
        assert lm.PinnedResolver is lu.PinnedResolver
